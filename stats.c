...
stats_init(void)
{
  ...
  stats.sets_collected = 0;
	...
	stats.proved_regular_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.proved_regular_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
	stats.retracted_regular_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.retracted_regular_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
	stats.proved_linear_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.proved_linear_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
	stats.retracted_linear_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.retracted_linear_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
	stats.consumed_linear_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.consumed_linear_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
  stats.tuples_sent_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.tuples_sent_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
  stats.tuples_sent_itself_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.tuples_sent_itself_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
  stats.tuples_allocated_by_type = meld_calloc(NUM_TYPES, sizeof(big_counter));
	stats.tuples_allocated_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
  stats.lists_allocated_by_type = meld_calloc(LIST_NUM_TYPES, sizeof(big_counter));
	stats.lists_allocated_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));

  stats.sets_allocated_by_type = meld_calloc(SET_NUM_TYPES, sizeof(big_counter));
	stats.sets_allocated_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
	stats.lists_collected_by_type = meld_calloc(LIST_NUM_TYPES, sizeof(big_counter));
	stats.lists_collected_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
  stats.sets_collected_by_type = meld_calloc(SET_NUM_TYPES, sizeof(big_counter));
	stats.sets_collected_by_thread = meld_calloc(NUM_THREADS, sizeof(big_counter));
