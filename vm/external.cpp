...
#define EXTERNAL3(NAME, RET, ARG1, ARG2, ARG3) external3(EXTERN(NAME), RET, ARG1, ARG2, ARG3)
   ...
   register_external_function(EXTERNAL1(listlength, FIELD_INT, FIELD_LIST_INT));
   ...
   register_external_function(EXTERNAL2(listappend, FIELD_LIST_INT, FIELD_LIST_INT, FIELD_LIST_INT));
   ...
   register_external_function(EXTERNAL1(listlength, FIELD_INT, FIELD_LIST_NODE));
   register_external_function(EXTERNAL2(nodelistcount, FIELD_INT, FIELD_LIST_NODE, FIELD_NODE));
   register_external_function(EXTERNAL2(listappend, FIELD_LIST_NODE, FIELD_LIST_NODE, FIELD_LIST_NODE));
   register_external_function(EXTERNAL1(node_priority, FIELD_FLOAT, FIELD_NODE));
   register_external_function(EXTERNAL1(listreverse, FIELD_LIST_NODE, FIELD_LIST_NODE));
   register_external_function(EXTERNAL1(listlast, FIELD_NODE, FIELD_LIST_NODE));
