...
typedef argument (*external_function_ptr5)(argument, argument, argument, argument, argument);
typedef argument (*external_function_ptr6)(argument, argument, argument, argument, argument, argument);
