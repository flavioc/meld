...
argument normalizestruct(const argument);
argument damp(const argument, const argument, const argument);
argument dampstruct(const argument, const argument, const argument);
argument divide(const argument, const argument);
argument dividestruct(const argument, const argument);
argument convolve(const argument, const argument);
argument convolvestruct(const argument, const argument);
argument addfloatlists(const argument, const argument);
argument addfloatstructs(const argument, const argument);
